...
# ============================================================
# 01_download_baseline.R
#
# Downloads baseline Qualtrics responses + uploaded files.
#
# Outputs:
#   data/qualtrics/<TEAM_SLUG>/baseline/responses.csv
#   data/qualtrics/<TEAM_SLUG>/baseline/uploaded_files_manifest.csv
#   data/qualtrics/<TEAM_SLUG>/baseline/uploads/<ResponseId>/*
#
# Requires:
...
SURVEY_ID <- "SV_40EOrjhnXulLWGG"  # baseline survey id
...
message("✅ Baseline download complete:")
